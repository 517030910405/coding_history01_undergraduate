...
main:
        ...
        mov     eax, 0
        call    getInt
        mov     qword [rel func_x], rax
        mov     eax, 0
        call    getInt
        mov     qword [rel func_y], rax
        mov     eax, 0
        call    getInt
        mov     qword [rel func_num], rax
        mov     eax, 0
        call    set_func
        mov     eax, 0
        call    getInt
...
func_num: dq 0000000000000001H

func_x: dq 0000000000000001H

func_x2: dq 0000000000000001H

func_valid:
        dq 0000000000000001H

func_y: dq 0000000000000001H
...
L_018:
        db 25H, 5BH, 5EH, 0AH, 0DH, 5DH, 00H
