...
void set_func2(){
	int tmp = (func_x*89+func_x2*97) & (func_maxnum-1);
	func_valid_arr[func_num][tmp] = 1;
	func_x_arr[func_num][tmp] = ((func_x<<32)^func_x2);
	func_y_arr[func_num][tmp] = func_y;
}
void seek_func2(){
	int tmp = (func_x*89+func_x2*97) & (func_maxnum-1);
	func_valid = 0;
	if (func_valid_arr[func_num][tmp] == 1 && func_x_arr[func_num][tmp] == ((func_x<<32)^func_x2)){
		func_y = func_y_arr[func_num][tmp];
		func_valid = 1;
	}
}
