...
regularizer = tf.contrib.layers.l2_regularizer(scale=6e-4)#5e-4
...
learning_rate = tf.train.exponential_decay(starter_learning_rate, global_step,1000, 0.5, staircase=True)
